document.addEventListener("DOMContentLoaded", () => {
    ...
    const produtos = [
        {
            ...
            preco: 79.99,
            imagem:
                "./assets/tuboredondo.jpg",
            descricao: "Tubos redondos em diversas medidas para aplicações estruturais e industriais.  Especificações: 1/2 a 8 Espessuras: 0,90mm a 3,00mm",
        },
        {
            id: 2,
            nome: "Tubo Quadrado",
            ...
            preco: 89.99,
            imagem:
                "./assets/açoquadrado.jpeg",
            descricao: "Tubos quadrados ideais para estruturas, grades e portões. Especificações:15x15 até 100x100 Espessuras: 0,90mm a 3,00mm",
        },
        {
            id: 3,
            nome: "Perfil U Dobrado Simples",
            categoria: "Perfis",
            preco: 95.99,
            imagem:
                "./assets/PERFIL-UDC.jpeg",
            descricao: "Perfis U dobrados para estruturas e reforços.   Especificações: 2x1 até 8x2 Espessuras: 2,25mm a 4,75mm ",
        },
        {
            id: 4,
            nome: "Perfis Dobrados Diversos",
            categoria: "Perfis",
            preco: 54.99,
            imagem:
                "./assets/perfil-dobrado.jpg",
            descricao: "Especificações: Medidas variadas Sob consulta",
        },
        {
         id: 5,
            nome: "Viga I 150x13kg/m",
            categoria: "vigas",
            preco: 54.99,
            imagem:
                "./assets/VigaI.jpeg",
            descricao: "Especificações: Altura: 150mm Peso: 13kg/m",
        },
        {
            id: 6,
          nome: "Viga I 200x19,3kg/m",
            categoria: "vigas",
            preco: 54.99,
            imagem:
                "./assets/VigaI.jpeg",
            descricao: "Especificações: Altura: 200mm Peso: 19,3kg/m",
        },
        {
            id: 7,
            nome: "Ferro Chato",
            ...
            preco: 124.99,
            imagem:
                "./assets/ferrochato.jpg",
            descricao: "Especificações: Medidas variadas Sob consulta",
        },
         {
            id: 8,
            nome: "Ferro Cantoneira",
            categoria: "ferros",
            preco: 124.99,
            imagem:
                "./assets/ferro-cantoneira.png",
            descricao: "Especificações: Medidas variadas Sob consulta",
        },
    ...
    const finalizarPedido = () => {
        ...
        const url = `https://wa.me/${5511976292707}?text=${encodeURIComponent(mensagem)}`;
